...
export default function LiquidationValuePage() {
    return (
        <div className="p-8 w-3/4">
            <h2 className="text-2xl mb-2">Liquidation Value</h2>
            <p>
            ...
            <p>
                ...
                calculator the formula is the follow: Cash plus Book value of Hard assets multiply by the (1 - discount) minus total liabilities.
            </p>
            <p>
